 ...
 */
public class ChatRoomMessageAdapater extends BaseAdapter {
    ...
    public ChatRoomMessageAdapater(Context context, List<ChatMessage> coll) {
        this.coll = coll;
    ...
    private static final String TAG = ChatRoomMessageAdapater.class.getSimpleName();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            switch (msgType) {
                case MESSAGE_TYPE_SEND_CHAT_CONTEXT:
                    ...
                    convertView = mInflater.inflate(R.layout.item_chatting_msg_send_room, null);
                ...
                case MESSAGE_TYPE_RECV_CHAT_CONTEXT:
                    ...
                    convertView = mInflater.inflate(R.layout.item_chatting_msg_receive_room, null);
                ...
                case MESSAGE_TYPE_SEND_FOLDER:
                    ...
                    convertView = mInflater.inflate(R.layout.item_send_file_room, null);
                ...
                case MESSAGE_TYPE_RECV_FOLDER:
                    ...
                    convertView = mInflater.inflate(R.layout.item_recevied_file_room, null);
        ...
        switch (msgType) {
            case MESSAGE_TYPE_SEND_CHAT_CONTEXT:
                ...
                viewHolder_chatSend.tv_userNick_send.setText(entity.fromNick);
                break;
            case MESSAGE_TYPE_RECV_CHAT_CONTEXT:
                ...
                viewHolder_chatReceive.tv_userNick_receive.setText(entity.fromNick);
                break;
            case MESSAGE_TYPE_SEND_FOLDER:
                ...
                viewHolder_sendFile.tv_userNick_send_folder.setText(entity.fromNick);
            ...
            case MESSAGE_TYPE_RECV_FOLDER:
                ...
                viewHolder_receiveFile.tv_userNick_receive_folder.setText(entity.fromNick);
